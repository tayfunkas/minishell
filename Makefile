...
SRCS = $(addprefix parsing/, parsing.c handling.c token_creation.c) \
	   $(addprefix command/, external_commands.c init_internal_commands.c internal_commands.c path.c execute_command.c external_command_helpers.c ft_cd_helpers.c ft_env_helpers.c) \
